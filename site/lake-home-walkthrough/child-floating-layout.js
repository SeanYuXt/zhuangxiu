...
export const layout={room:[0,0,3.50,2.70],bay:[3.50,.34,4.11,1.95],sillHeight:.55,
 ...
 wardrobe:[.0,.02,.50,1.22],desk:[2.68,.02,3.48,.72],returnTop:[3.50,.62,4.09,1.93],
 chair:[2.80,.76,3.36,1.34],chairBaseDiameter:.65,pull:.30,
 computer:{tower:[3.56,.80,3.96,1.02],towerBase:.765,towerHeight:.45,
  knee:[2.76,.09,3.42,.70],kneeHeight:.70,
 ...
 joinery:{headUpper:[.50,.02,2.68,.28],headUpperBottom:1.95,upperTop:2.48,
  ...
  continuousTop:[[2.68,.02],[3.48,.02],[3.48,.36],[4.09,.36],[4.09,1.93],[3.50,1.93],[3.50,.72],[2.68,.72]],
