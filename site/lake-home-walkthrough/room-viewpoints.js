...
export const roomViewpoints=[
 shot('living-tv','living','电视与横向展示带',[8.65,1.6,3.66],[11.85,1.36,3.66],['85-inch-screen','tv-display-columns']),
 ...
 shot('balcony-care','care','洗手台与扫地机',[9.05,1.6,.75],[6.23,1.08,.91],['balcony-care-cabinet','balcony-robot-dock']),
 shot('balcony-laundry','laundry','洗烘与操作区',[7.65,1.55,.74],[11.55,1.38,.69],['laundry-washer','laundry-dryer']),
];
