...
import {layout as d,audit,doorTip} from './child-original-door-layout.js?v=chair-space-84';
import {addComputerZone} from './child-computer-zone.js?v=chair-space-84';
import {chairGeometry,chairCheck} from './child-chair-clearance.js?v=chair-space-84';
...
label(1.75,-.12,'350cm');label(1.90,1.05,'150×200cm床',.12);label(.24,.58,'衣柜',.10);label(.24,.76,'120×50',.085);label(3.08,.48,'80×60桌',.085);label(3.8,1.32,'台面退回飘窗',.065);label(3.76,.95,'机箱',.065);label(1.85,2.47,'床尾62cm');label(.81,.70,'62cm');label(3.08,2.05,'椅侧净宽84cm',.075);label(3.02,2.36,'后撤区不设下柜',.075);
