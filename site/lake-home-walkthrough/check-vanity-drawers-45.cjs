...
(async()=>{
 ...
 await page.goto('http://127.0.0.1:8768/lake-home-walkthrough/master-suite-plumbing-study.html?view=footwall&v=vanity-drawers-45');
 ...
 const shot=async name=>{await page.waitForTimeout(250);await page.locator('#scene').screenshot({path:'D:/tep-chat/output/lake-home-walkthrough/master-suite-review-solid-head/vanity-drawers-45-'+name+'.png'});};
 await shot('closed');
 ...
 await page.evaluate(()=>masterPlumbing.choose('footElevation'));await page.locator('#plan').screenshot({path:'D:/tep-chat/output/lake-home-walkthrough/master-suite-review-solid-head/vanity-drawers-45-elevation.png'});
 ...
 await page.locator('#plan').screenshot({path:'D:/tep-chat/output/lake-home-walkthrough/master-suite-review-solid-head/vanity-drawers-45-plan-open.png'});
